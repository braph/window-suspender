...
{
       0,    86,    86,    90,    90,    90,    90,    90,    90,    94,
      95,    96,    97,    98,    99,   100,   101,   102,   103,   107,
     108,   109,   113,   117,   121,   122,   126,   127,   128,   129,
     133,   134,   135
};
#endif
...
static const char *const yytname[] =
{
  ...
  "REGEX_UNEQUAL", "PRINT", "SUSPEND", "RETURN", "OPTION_SUSPEND_DELAY",
  "OPTION_REFRESH_DELAY", "OPTION_REFRESH_DURATION", "COND_TYPE",
  "COND_STACKPOSITION", "COND_STATE", "NOT", "AND_AND", "OR_OR", "'('",
  "')'", "'{'", "'}'", "';'", "$accept", "config", "numeric_comparison",
  "condition", "statement", "if_statement", "compound_statement",
  "statement_list", "suspend_statement", "command_statement", YY_NULLPTR
};
#endif
...
{
     -15,     4,   -20,     1,    -6,   -15,    36,   -15,   -20,   -20,
     -20,   -12,   -20,     6,   -20,    -4,    28,    17,    29,    -6,
       5,     9,   -20,   -20,    38,    39,    40,   -20,   -20,    37,
      42,    43,    44,    45,   -20,   -20,   -20,   -20,   -20,   -20,
      46,    47,    -5,    -6,    -6,   -15,   -20,   -20,   -20,   -20,
     -20,   -20,   -20,   -20,   -20,   -20,   -20,    -5,    -5,   -20
};
...
{
       0,     0,    26,     0,     0,     0,     0,    24,    19,    21,
       2,     0,    20,     0,    31,     0,     0,     0,     0,     0,
       0,     0,     1,    25,     0,     0,     0,    32,    30,     0,
       0,     0,     0,     0,     3,     4,     5,     6,     7,     8,
       0,     0,    18,     0,     0,     0,    23,    27,    28,    29,
       9,    11,    10,    12,    13,    15,    14,    16,    17,    22
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -20,   -20,   -20,   -19,     3,   -20,   -20,     8,   -20,   -20
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     6,    40,    20,     7,     8,     9,    10,    11,    12
};
...
{
      42,    15,     1,     2,     3,    29,    30,    13,    24,    25,
      26,    31,    32,    21,     4,    23,     5,    16,    17,    18,
      19,    27,    43,    44,    57,    58,    34,    35,    36,    37,
      38,    39,    43,    44,    14,    45,    22,    33,    41,    28,
      50,    46,    47,    48,    49,    51,    52,    53,    59,     0,
      55,    54,    56
};

static const yytype_int8 yycheck[] =
{
      19,     7,    17,    18,    19,     9,    10,     3,    20,    21,
      22,    15,    16,     5,    29,     7,    31,    23,    24,    25,
      26,    33,    27,    28,    43,    44,     9,    10,    11,    12,
      13,    14,    27,    28,    33,    30,     0,     9,     9,    33,
       3,    32,     4,     4,     4,     3,     3,     3,    45,    -1,
       4,     6,     5
};
...
{
       0,    17,    18,    19,    29,    31,    35,    38,    39,    40,
      41,    42,    43,     3,    33,     7,    23,    24,    25,    26,
      37,    41,     0,    41,    20,    21,    22,    33,    33,     9,
      10,    15,    16,     9,     9,    10,    11,    12,    13,    14,
      36,     9,    37,    27,    28,    30,    32,     4,     4,     4,
       3,     3,     3,     3,     6,     4,     5,    37,    37,    38
};
...
yyreduce:
  ...
  case 2:
#line 86 "config.y"
    { root.next = (yyvsp[0].statement); }
#line 1358 "y.tab.c"
    break;

  case 9:
#line 94 "config.y"
    { (yyval.conditional) = conditional_string_match_new((yyvsp[-2].field), (yyvsp[0].string)); }
#line 1364 "y.tab.c"
    break;

  case 10:
#line 95 "config.y"
    { (yyval.conditional) = conditional_regex_match_new((yyvsp[-2].field), (yyvsp[0].string)); }
#line 1370 "y.tab.c"
    break;

  case 11:
#line 96 "config.y"
    { (yyval.conditional) = C_NOT(conditional_string_match_new((yyvsp[-2].field), (yyvsp[0].string))); }
#line 1376 "y.tab.c"
    break;

  case 12:
#line 97 "config.y"
    { (yyval.conditional) = C_NOT(conditional_regex_match_new((yyvsp[-2].field), (yyvsp[0].string))); }
#line 1382 "y.tab.c"
    break;
